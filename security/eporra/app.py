...
from vistas import VistaApuestas, VistaApuesta, VistaSignIn, VistaLogIn, VistaCarrerasUsuario, \
    VistaCarrera, VistaTerminacionCarrera, VistaReporte, VistaUsuarios, VistaTransacciones, VistaApostador, VistaUsuario, VistaKong
...
api.add_resource(VistaApostador, '/apostador/<int:id_apuesta>')
api.add_resource(VistaTransacciones, '/transacciones')
api.add_resource(VistaUsuario, '/apostadores/<int:id_usuario>')
